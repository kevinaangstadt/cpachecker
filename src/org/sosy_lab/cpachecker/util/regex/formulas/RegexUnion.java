...
public class RegexUnion implements RegexOperator {
  private final RegexOperator re1, re2;

  public static RegexUnion of(RegexOperator re1, RegexOperator re2) {
    return new RegexUnion(re1, re2);
  }

  public RegexUnion(RegexOperator re1, RegexOperator re2) {
    this.re1 = re1;
    this.re2 = re2;
  }
  ...
  public boolean equals(Object obj) {
    ...
    RegexUnion other = (RegexUnion) obj;
    if (this.re1.equals(other.re1) && this.re2.equals(other.re2)) {
      return true;
    }
    if (this.re1.equals(other.re2) && this.re2.equals(other.re1)) {
      return true;
    }
  ...
  public RegexFormula toFormula(StringFormulaManagerView pSfmgr) {
    return pSfmgr.regexUnion(re1.toFormula(pSfmgr), re2.toFormula(pSfmgr));
  }
}
