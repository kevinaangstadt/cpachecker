...
public class RegexPlus implements RegexOperator {
  private final RegexOperator re;

  public static RegexPlus of(RegexOperator re) {
    return new RegexPlus(re);
  }

  public RegexPlus(RegexOperator re) {
    this.re = re;
  }
